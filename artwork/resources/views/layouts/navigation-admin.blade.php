            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(Auth::user()->role == 'curator')
                        ...
                        <x-nav-link :href="route('curator.challenges.index')" :active="request()->routeIs('curator.challenges.index')">
                            Manajemen Challenge
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif(Auth::user()->role == 'curator')
                ...
                <x-responsive-nav-link :href="route('curator.challenges.index')" :active="request()->routeIs('curator.challenges.index')">
                    Manajemen Challenge
                </x-responsive-nav-link>
