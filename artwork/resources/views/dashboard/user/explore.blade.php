        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                ...
                <div class="relative group rounded-lg overflow-hidden shadow hover:shadow-lg bg-white">
                    <img src="{{ Storage::url($artwork->file_path) }}" alt="{{ $artwork->title }}" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300">
                    ...
                    <div class="flex items-center justify-between px-3 py-2">
                        <div class="flex items-center gap-2">
                            ...
                            <img src="{{ asset($artwork->user->profile_picture ?? 'images/default.png') }}" class="w-6 h-6 rounded-full" alt="{{ $artwork->user->name }}">
